...
public class SignIn extends UseCase<User, SignIn.Params> {
    ...
    @Inject
    SignIn(UserRepository userRepository, ThreadExecutor threadExecutor,
    ...
    public static final class Params {
        ...
        public static SignIn.Params forSignIn(String email, String password) {
            return new SignIn.Params(email, password);
        }
    }
}
