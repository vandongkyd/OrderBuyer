 ...
 * active user.
 */
public class ActiveUser extends UseCase<User, ActiveUser.Params> {

    private final UserRepository userRepository;

    @Inject
    ActiveUser(UserRepository userRepository, ThreadExecutor threadExecutor,
    ...
    public static final class Params {
        ...
        public static ActiveUser.Params forActiveUser(String token, String active_code) {
            return new ActiveUser.Params(token, active_code);
        }
    }
}
