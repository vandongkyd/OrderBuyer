...
public class AddSourceActivity extends StripeActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewStub.inflate();
        mCardMultilineWidget = (CardMultilineWidget)findViewById(R.id.add_source_card_entry_widget);
        mErrorLayout = (FrameLayout) findViewById(R.id.add_source_error_container);
