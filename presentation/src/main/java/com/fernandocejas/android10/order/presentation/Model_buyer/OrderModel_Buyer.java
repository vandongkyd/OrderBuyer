...
public class OrderModel_Buyer {
    ...
    private AddressModel address_buyer ;
    private String ios ;
    ...
    public AddressModel getAddress_buyer() {
        return address_buyer;
    }

    public void setAddress_buyer(AddressModel address_buyer) {
