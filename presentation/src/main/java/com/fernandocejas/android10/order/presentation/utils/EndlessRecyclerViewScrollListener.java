...
public abstract class EndlessRecyclerViewScrollListener implements NestedScrollView.OnScrollChangeListener {
        ...
        if (view.getChildAt(view.getChildCount() - 1) != null) {
            if ((scrollY >= (view.getChildAt(view.getChildCount() - 1).getMeasuredHeight() - view.getMeasuredHeight())) &&
                ...
                if (loading && (totalItemCount > previousTotalItemCount)) {
                    loading = false;
                    pageSize = totalItemCount - previousTotalItemCount;
    ...
    public void onLoadError() {
        this.currentPage--;
        int totalItemCount = mLayoutManager.getItemCount();
        previousTotalItemCount = totalItemCount - pageSize;
    }
