...
public class AccountInformationActivity extends BaseActivity implements HasComponent<OrderComponent> {

    public static Intent getCallingIntent(Context context) {
        return new Intent(context, AccountInformationActivity.class);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            addFragment(R.id.fragmentContainer, new AccountInformationFragment());
        }
    }
