...
public class PlaceAutocompleteAdapter
    ...
    private static final String TAG = "PlaceAutocompleteAdp";
    ...
    public PlaceAutocompleteAdapter(Context context, GeoDataClient geoDataClient,
        ...
        super(context, R.layout.row_address_with_hint, R.id.tv_text);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView textView1 = row.findViewById(R.id.tv_text);
        TextView textView2 = row.findViewById(R.id.tv_hint);
