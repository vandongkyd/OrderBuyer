...
public class CardInputWidget extends LinearLayout {
    ...
    void updateSpaceSizes(boolean isCardViewed) {
        ...
        @CardBrand String brand = mCardNumberEditText.getCardBrand();
    ...
    private void initView(AttributeSet attrs) {
        ...
        mCardNumberEditText.setCardBrandChangeListener(
                new CardNumberEditText.CardBrandChangeListener() {
                    @Override
                    public void onCardBrandChanged(@NonNull @CardBrand String brand) {
    ...
    @NonNull
    private String getCvcPlaceHolderForBrand(@NonNull @CardBrand String brand) {
        if (Card.AMERICAN_EXPRESS.equals(brand)) {
    ...
    @NonNull
    private String getPeekCardTextForBrand(@NonNull @CardBrand String brand) {
        if (Card.AMERICAN_EXPRESS.equals(brand)) {
    ...
    private void updateCvc(@NonNull @CardBrand String brand) {
        if (Card.AMERICAN_EXPRESS.equals(brand)) {
    ...
    private void updateIcon(@NonNull @CardBrand String brand) {
        if (Card.UNKNOWN.equals(brand)) {
            Drawable icon = getResources().getDrawable(R.drawable.ic_credit_card);
